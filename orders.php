...
<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
  ...
  if(!isset($_SESSION['shopowner'])){
    ...
    if(mysqli_num_rows($selectshopinfo)==1){
      $_SESSION['shopowner']=$email;
      $shopdetails=mysqli_fetch_array($selectshopinfo);
    }
    else{
    header("location:http://www.localhost/unname/shop-register.php");
    exit();
  }
  }
 ...
 $("#menu-body").css('height',windowHeight);
  ...
  <body id="body-container">
      ...
      <div id="menu-body" >
       ...
       <br>
       <a href="http://localhost/unname/shop-owner-add-or-edit-item.php">
       ...
       <br>
       <a href="http://localhost/unname/shop-order-history.php">
    ...
    $(document).ready(function(){
      ...
      $("#pending-order-button-box").click(function(){
        ...
        <div id="main-body">
          ...
          <div id="order-body-block">
            <div id="order-box">
              <div id="new-order-button-box">
                <button id="new-order-button" > new orders </button>
              </div>
              <div id="pending-order-button-box">
                <button id="pending-order-button" >pending orders </button>
              </div>
            </div>
          </div>
...
#pending-order-body{
  display:none;
          ...
          $email=$_SESSION['userid'];
          $con=new mysqli("localhost","root","","withmerce");
          $selectitemorder=mysqli_query($con,"select * from itemorder where shopowneremail='$email' AND status=1 ");
          ...
          <div id="new-order-body">
            <?php while($shopdata=mysqli_fetch_array($selectitemorder)){
              $uniqueid=$shopdata['itemuniqueid'];
          ...
          <div id="item-details-body">
            ...
            <div id="view-more-details-body">
              <a href="/unname/new-order.php?itemorderid=<?php echo $itemorderid; ?>" >
                <input type="hidden">
                <input type="submit" value="check out" id="view-more-details">
              </a>
            </div>
